...
/**
 * The analytics prompt: non-blocking, never a full-screen modal. A prompt
 * standing between a person and the privacy policy it links to is the
 * pattern regulators single out.
 *
...
export function ConsentBanner() {
  ...
  return (
    <Banner label={t("settings.analyticsPromptTitle")}>
       ...
       * and the overflow pushed the refusal off-screen. A column keeps
       * refusing exactly as reachable as accepting whatever the locale's
       * label lengths.
       */}
