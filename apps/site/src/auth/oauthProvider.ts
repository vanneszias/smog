 ...
 * rules need neither.
 *
 * **The address must be verified even when no account exists yet.** The
 * obvious case is *linking* to an existing password account, because that is
 * the account-takeover one. Requiring it for registration too closes the
