...
This event is only available within the JavaScript Core SDK. For Swift on Apple platforms, see the section on changing the video in Custom Swift integration. For Java, there are helper methods for this exposed within MuxStats.
