...
**Source:** https://mux.com/docs/_guides/examples/use-videos-in-your-website-design
...
The ` element inside acts as a poster image while the video loads.
...
Mux Background Video requires Basic or Premium video quality.
...
Why choose MP4:
- No JavaScript required—just a  tag
...
For more details on static renditions, see Use static MP4 and M4A renditions.
...
See Get images from a video for more thumbnail options.
