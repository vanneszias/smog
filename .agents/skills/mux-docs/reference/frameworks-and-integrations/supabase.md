...
**Source:** https://mux.com/docs/_guides/integrations/supabase
...
You can find your API credentials in the Mux Dashboard. The webhook secret will be generated when you configure the webhook in step 4.
...
To receive webhooks locally, you'll need to expose your local server using a tool like ngrok. Configure the ngrok URL as your webhook endpoint in the Mux dashboard.
