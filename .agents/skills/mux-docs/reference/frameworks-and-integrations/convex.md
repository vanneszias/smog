...
**Source:** https://mux.com/docs/_guides/integrations/convex
...
- A Convex project with a convex/ directory already initialized
- The Convex CLI installed (npm install -g convex)
- A TypeScript web application (e.g., Next.js, React, or any Convex-supported framework)

New to Convex? Follow the Convex quickstart for your framework first, then come back here to add Mux integration.
...
You can find your API credentials in the Mux Dashboard.
...
Check your Convex dashboard to verify the tables are populated:
