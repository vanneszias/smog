...
## Table of Contents
- [Project Structure](#project-structure) - File-based routing organization
- [Root Layout](#root-layout) - App-wide layout configuration
- [Tab Layout](#tab-layout) - Bottom tab navigation
- [Navigation](#navigation) - Programmatic and declarative navigation
- [Protected Routes](#protected-routes) - Authentication guards
- [Deep Linking](#deep-linking) - URL scheme configuration
- [Quick Reference](#quick-reference) - Components and methods
