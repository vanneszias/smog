...
## Table of Contents
- [Optimized FlatList](#optimized-flatlist) - Memoization, performance props
- [SectionList](#sectionlist) - Grouped lists with headers
- [Pull to Refresh](#pull-to-refresh) - RefreshControl implementation
- [Infinite Scroll](#infinite-scroll) - Pagination and loading more
- [FlashList (Alternative)](#flashlist-alternative) - High-performance alternative
- [Quick Reference](#quick-reference) - Props and optimization guide
