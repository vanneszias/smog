...
## Table of Contents
- [Platform.select](#platformselect) - Platform-specific values
- [Platform.OS](#platformos) - Conditional rendering
- [Platform-Specific Files](#platform-specific-files) - .ios.tsx / .android.tsx
- [SafeAreaView](#safeareaview) - Notch and safe area handling
- [KeyboardAvoidingView](#keyboardavoidingview) - Keyboard management
- [StatusBar](#statusbar) - Status bar styling
- [Android Back Button](#android-back-button) - Hardware back handling
- [Quick Reference](#quick-reference) - API overview
