...
**Tech Stack:** Payload 3.82.1, `@payloadcms/db-d1-sqlite`, `@payloadcms/plugin-search`, `@payloadcms/richtext-lexical`, Vitest.
...
```bash
bun add -F site @payloadcms/plugin-search@3.82.1
```
